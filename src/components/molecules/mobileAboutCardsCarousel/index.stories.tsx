...
import { MobileAboutCardsCarousel } from "./index";
import { AboutCardProps } from "@/components/atoms/aboutCard";

const meta = {
  title: "Molecules/MobileAboutCardsCarousel",
  component: MobileAboutCardsCarousel,
} satisfies Meta<typeof MobileAboutCardsCarousel>;

export default meta;
type Story = StoryObj<typeof meta>;

const mockCards: AboutCardProps[] = [
  {
    title: "About",
    type: "text",
    description:
